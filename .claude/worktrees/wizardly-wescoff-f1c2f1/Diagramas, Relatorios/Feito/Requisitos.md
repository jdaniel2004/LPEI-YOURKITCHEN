...
RF1 O sistema deve permitir visualizar um mapa de mesas com estado em tempo real (livre, ocupada, reservada, a aguardar conta)
...
RF6 O sistema deve suportar múltiplos pedidos por mesa ao longo do tempo (rondas)
...
RF32 O sistema deve mostrar um dashboard com KPIs em tempo real (faturação do dia, mesas abertas, etc.)
